...
h===THREE.SubtractiveBlending&&(b.globalCompositeOperation="darker"),xa=h)}function I(h){oa!==h&&(oa=b.lineWidth=h)}function z(h){ga!==h&&(ga=b.lineCap=h)}function G(h){va!==h&&(va=b.lineJoin=h)}function N(h){ca!==h&&(ca=b.strokeStyle=h)}function A(h){O!==h&&(O=b.fillStyle=h)}function E(h){ma.length!==h.length&&(b.setLineDash(h),ma=h)}console.log("THREE.CanvasRenderer",THREE.REVISION);var ka=THREE.Math.smoothstep;g=g||{};var U=this,ha,S,da,la=new THREE.Projector,y=void 0!==g.canvas?g.canvas:document.createElement("canvas"),
r=y.width,u=y.height,l=Math.floor(r/2),D=Math.floor(u/2),P=0,ia=0,m=r,ea=u,c=1,b=y.getContext("2d",{alpha:!0===g.alpha}),Y=new THREE.Color(0),F=!0===g.alpha?0:1,t=1,xa=0,ca=null,O=null,oa=null,ga=null,va=null,ma=[],pa,n,R,fa;new THREE.RenderableVertex;new THREE.RenderableVertex;var X,ya,x,f,C,qa,v=new THREE.Color;new THREE.Color;new THREE.Color;new THREE.Color;new THREE.Color;var Z=new THREE.Color,J=new THREE.Color,ja=new THREE.Color,H={},h,Q,aa,ua,wa,Ba,Ca,na=new THREE.Box2,K=new THREE.Box2,ba=new THREE.Box2,
Aa=new THREE.Color,Da=new THREE.Color,ra=new THREE.Color,sa=new THREE.Vector3,Ea=new THREE.Vector3,ta=new THREE.Vector3,za=new THREE.Matrix3;void 0===b.setLineDash&&(b.setLineDash=function(){});this.domElement=y;this.sortElements=this.sortObjects=this.autoClear=!0;this.info={render:{vertices:0,faces:0}};this.supportsVertexTextures=function(){};this.setFaceCulling=function(){};this.getPixelRatio=function(){return c};this.setPixelRatio=function(h){c=h};this.setSize=function(h,a,b){r=h*c;u=a*c;y.width=
r;y.height=u;l=Math.floor(r/2);D=Math.floor(u/2);!1!==b&&(y.style.width=h+"px",y.style.height=a+"px");na.min.set(-l,-D);na.max.set(l,D);K.min.set(-l,-D);K.max.set(l,D);t=1;xa=0;va=ga=oa=O=ca=null;this.setViewport(0,0,h,a)};this.setViewport=function(h,a,b,Q){P=h*c;ia=a*c;m=b*c;ea=Q*c};this.setScissor=function(){};this.enableScissorTest=function(){};this.setClearColor=function(h,a){Y.set(h);F=void 0!==a?a:1;K.min.set(-l,-D);K.max.set(l,D)};this.setClearColorHex=function(h,a){console.warn("THREE.CanvasRenderer: .setClearColorHex() is being removed. Use .setClearColor() instead.");
this.setClearColor(h,a)};this.getClearColor=function(){return Y};this.getClearAlpha=function(){return F};this.getMaxAnisotropy=function(){return 0};this.clear=function(){!1===K.empty()&&(K.intersect(na),K.expandByScalar(2),K.min.x+=l,K.min.y=-K.min.y+D,K.max.x+=l,K.max.y=-K.max.y+D,1>F&&b.clearRect(K.min.x|0,K.max.y|0,K.max.x-K.min.x|0,K.min.y-K.max.y|0),0<F&&(T(THREE.NormalBlending),s(1),A("rgba("+Math.floor(255*Y.r)+","+Math.floor(255*Y.g)+","+Math.floor(255*Y.b)+","+F+")"),b.fillRect(K.min.x|0,
K.max.y|0,K.max.x-K.min.x|0,K.min.y-K.max.y|0)),K.makeEmpty())};this.clearColor=function(){};this.clearDepth=function(){};this.clearStencil=function(){};this.render=function(c,g){if(!1===g instanceof THREE.Camera)console.error("THREE.CanvasRenderer.render: camera is not an instance of THREE.Camera.");else{!0===this.autoClear&&this.clear();U.info.render.vertices=0;U.info.render.faces=0;b.setTransform(m/r,0,0,-ea/u,P,u-ia);b.translate(l,D);ha=la.projectScene(c,g,this.sortObjects,this.sortElements);
S=ha.elements;da=ha.lights;pa=g;za.getNormalMatrix(g.matrixWorldInverse);Aa.setRGB(0,0,0);Da.setRGB(0,0,0);ra.setRGB(0,0,0);for(var Y=0,O=da.length;Y<O;Y++){var q=da[Y],M=q.color;q instanceof THREE.AmbientLight?Aa.add(M):q instanceof THREE.DirectionalLight?Da.add(M):q instanceof THREE.PointLight&&ra.add(M)}Y=0;for(O=S.length;Y<O;Y++){var B=S[Y],F=B.material;if(void 0!==F&&0!==F.opacity){ba.makeEmpty();if(B instanceof THREE.RenderableSprite){n=B;n.x*=l;n.y*=D;var q=n,L=B,M=F;s(M.opacity);T(M.blending);
var y=L.scale.x*l,L=L.scale.y*D,B=.5*Math.sqrt(y*y+L*L);ba.min.set(q.x-B,q.y-B);ba.max.set(q.x+B,q.y+B);if(M instanceof THREE.SpriteMaterial){var V=M.map;if(null!==V&&void 0!==V.image){!1===V.hasEventListener("update",w)&&(0<V.image.width&&p(V),V.addEventListener("update",w));B=H[V.id];void 0!==B?A(B):A("rgba( 0, 0, 0, 1 )");var W=V.image,B=W.width*V.offset.x,F=W.height*V.offset.y,t=W.width*V.repeat.x,V=W.height*V.repeat.y,W=y/t,ca=L/V;b.save();b.translate(q.x,q.y);0!==M.rotation&&b.rotate(M.rotation);
b.translate(-y/2,-L/2);b.scale(W,ca);b.translate(-B,-F);b.fillRect(B,F,t,V)}else A(M.color.getStyle()),b.save(),b.translate(q.x,q.y),0!==M.rotation&&b.rotate(M.rotation),b.scale(y,-L),b.fillRect(-.5,-.5,1,1);b.restore()}else M instanceof THREE.SpriteCanvasMaterial&&(N(M.color.getStyle()),A(M.color.getStyle()),b.save(),b.translate(q.x,q.y),0!==M.rotation&&b.rotate(M.rotation),b.scale(y,L),M.program(b),b.restore())}else if(B instanceof THREE.RenderableLine){if(n=B.v1,R=B.v2,n.positionScreen.x*=l,n.positionScreen.y*=
D,R.positionScreen.x*=l,R.positionScreen.y*=D,ba.setFromPoints([n.positionScreen,R.positionScreen]),!0===na.isIntersectionBox(ba))if(q=n,M=R,y=B,L=F,s(L.opacity),T(L.blending),b.beginPath(),b.moveTo(q.positionScreen.x,q.positionScreen.y),b.lineTo(M.positionScreen.x,M.positionScreen.y),L instanceof THREE.LineBasicMaterial){I(L.linewidth);z(L.linecap);G(L.linejoin);if(L.vertexColors!==THREE.VertexColors)N(L.color.getStyle());else if(B=y.vertexColors[0].getStyle(),y=y.vertexColors[1].getStyle(),B===
y)N(B);else{try{var ga=b.createLinearGradient(q.positionScreen.x,q.positionScreen.y,M.positionScreen.x,M.positionScreen.y);ga.addColorStop(0,B);ga.addColorStop(1,y)}catch(ma){ga=B}N(ga)}b.stroke();ba.expandByScalar(2*L.linewidth)}else L instanceof THREE.LineDashedMaterial&&(I(L.linewidth),z(L.linecap),G(L.linejoin),N(L.color.getStyle()),E([L.dashSize,L.gapSize]),b.stroke(),ba.expandByScalar(2*L.linewidth),E([]))}else if(B instanceof THREE.RenderableFace){n=B.v1;R=B.v2;fa=B.v3;if(-1>n.positionScreen.z||
1<n.positionScreen.z)continue;if(-1>R.positionScreen.z||1<R.positionScreen.z)continue;if(-1>fa.positionScreen.z||1<fa.positionScreen.z)continue;n.positionScreen.x*=l;n.positionScreen.y*=D;R.positionScreen.x*=l;R.positionScreen.y*=D;fa.positionScreen.x*=l;fa.positionScreen.y*=D;0<F.overdraw&&(e(n.positionScreen,R.positionScreen,F.overdraw),e(R.positionScreen,fa.positionScreen,F.overdraw),e(fa.positionScreen,n.positionScreen,F.overdraw));ba.setFromPoints([n.positionScreen,R.positionScreen,fa.positionScreen]);
if(!0===na.isIntersectionBox(ba)){M=n;y=R;L=fa;q=F;U.info.render.vertices+=3;U.info.render.faces++;s(q.opacity);T(q.blending);X=M.positionScreen.x;ya=M.positionScreen.y;x=y.positionScreen.x;f=y.positionScreen.y;C=L.positionScreen.x;qa=L.positionScreen.y;var F=X,t=ya,V=x,W=f,ca=C,oa=qa;b.beginPath();b.moveTo(F,t);b.lineTo(V,W);b.lineTo(ca,oa);b.closePath();if((q instanceof THREE.MeshLambertMaterial||q instanceof THREE.MeshPhongMaterial)&&null===q.map){Z.copy(q.color);J.copy(q.emissive);q.vertexColors===
THREE.FaceColors&&Z.multiply(B.color);v.copy(Aa);Ea.copy(M.positionWorld).add(y.positionWorld).add(L.positionWorld).divideScalar(3);M=Ea;y=B.normalModel;L=v;B=0;for(F=da.length;B<F;B++)t=da[B],ja.copy(t.color),t instanceof THREE.DirectionalLight?(V=sa.setFromMatrixPosition(t.matrixWorld).normalize(),W=y.dot(V),0>=W||(W*=t.intensity,L.add(ja.multiplyScalar(W)))):t instanceof THREE.PointLight&&(V=sa.setFromMatrixPosition(t.matrixWorld),W=y.dot(sa.subVectors(V,M).normalize()),0>=W||(W*=0==t.distance?
1:1-Math.min(M.distanceTo(V)/t.distance,1),0!=W&&(W*=t.intensity,L.add(ja.multiplyScalar(W)))));v.multiply(Z).add(J);!0===q.wireframe?k(v,q.wireframeLinewidth,q.wireframeLinecap,q.wireframeLinejoin):d(v)}else q instanceof THREE.MeshBasicMaterial||q instanceof THREE.MeshLambertMaterial||q instanceof THREE.MeshPhongMaterial?null!==q.map?q.map.mapping===THREE.UVMapping&&(h=B.uvs,a(X,ya,x,f,C,qa,h[0].x,h[0].y,h[1].x,h[1].y,h[2].x,h[2].y,q.map)):null!==q.envMap?q.envMap.mapping===THREE.SphericalReflectionMapping&&
(ta.copy(B.vertexNormalsModel[0]).applyMatrix3(za),Q=.5*ta.x+.5,aa=.5*ta.y+.5,ta.copy(B.vertexNormalsModel[1]).applyMatrix3(za),ua=.5*ta.x+.5,wa=.5*ta.y+.5,ta.copy(B.vertexNormalsModel[2]).applyMatrix3(za),Ba=.5*ta.x+.5,Ca=.5*ta.y+.5,a(X,ya,x,f,C,qa,Q,aa,ua,wa,Ba,Ca,q.envMap)):(v.copy(q.color),q.vertexColors===THREE.FaceColors&&v.multiply(B.color),!0===q.wireframe?k(v,q.wireframeLinewidth,q.wireframeLinecap,q.wireframeLinejoin):d(v)):(q instanceof THREE.MeshDepthMaterial?v.r=v.g=v.b=1-ka(M.positionScreen.z*
M.positionScreen.w,pa.near,pa.far):q instanceof THREE.MeshNormalMaterial?(ta.copy(B.normalModel).applyMatrix3(za),v.setRGB(ta.x,ta.y,ta.z).multiplyScalar(.5).addScalar(.5)):v.setRGB(1,1,1),!0===q.wireframe?k(v,q.wireframeLinewidth,q.wireframeLinecap,q.wireframeLinejoin):d(v))}}K.union(ba)}}b.setTransform(1,0,0,1,0,0)}}};THREE.RenderableObject=function(){this.id=0;this.object=null;this.z=0};
...
THREE.Projector=function(){function g(){if(G===A){var a=new THREE.RenderableVertex;N.push(a);A++;G++;return a}return N[G++]}function k(){if(ka===ha){var a=new THREE.RenderableFace;U.push(a);ha++;ka++;return a}return U[ka++]}function d(){if(da===y){var a=new THREE.RenderableLine;la.push(a);y++;da++;return a}return la[da++]}function w(){if(u===D){var a=new THREE.RenderableSprite;l.push(a);D++;u++;return a}return l[u++]}function p(a,c){return a.z!==c.z?c.z-a.z:a.id!==c.id?a.id-c.id:0}function a(a,c){var b=
0,d=1,e=a.z+a.w,f=c.z+c.w,g=-a.z+a.w,k=-c.z+c.w;if(0<=e&&0<=f&&0<=g&&0<=k)return!0;if(0>e&&0>f||0>g&&0>k)return!1;0>e?b=Math.max(b,e/(e-f)):0>f&&(d=Math.min(d,e/(e-f)));0>g?b=Math.max(b,g/(g-k)):0>k&&(d=Math.min(d,g/(g-k)));if(d<b)return!1;a.lerp(c,b);c.lerp(a,1-d);return!0}var e,s,T=[],I=0,z,G,N=[],A=0,E,ka,U=[],ha=0,S,da,la=[],y=0,r,u,l=[],D=0,P={objects:[],lights:[],elements:[]},ia=new THREE.Vector3,m=new THREE.Vector3,ea=new THREE.Vector3,c=new THREE.Vector3,b=new THREE.Vector4,Y=new THREE.Box3(new THREE.Vector3(-1,
-1,-1),new THREE.Vector3(1,1,1)),F=new THREE.Box3,t=Array(3),xa=new THREE.Matrix4,ca=new THREE.Matrix4,O,oa=new THREE.Matrix4,ga=new THREE.Matrix3,va=new THREE.Frustum,ma=new THREE.Vector4,pa=new THREE.Vector4;this.projectVector=function(a,c){console.warn("THREE.Projector: .projectVector() is now vector.project().");a.project(c)};this.unprojectVector=function(a,c){console.warn("THREE.Projector: .unprojectVector() is now vector.unproject().");a.unproject(c)};this.pickingRay=function(a,c){console.error("THREE.Projector: .pickingRay() is now raycaster.setFromCamera().")};
...
v=C.length;f<v;f+=3)n.pushTriangle(C[f],C[f+1],C[f+2]);else for(f=0,v=t.length/3;f<v;f+=3)n.pushTriangle(f,f+1,f+2)}}else{if(f instanceof THREE.Geometry){var J=f.vertices,v=f.faces,C=f.faceVertexUvs[0];ga.getNormalMatrix(O);for(var t=x.material instanceof THREE.MeshFaceMaterial,z=!0===t?x.material:null,A=0,H=J.length;A<H;A++){var h=J[A];n.pushVertex(h.x,h.y,h.z)}J=0;for(A=v.length;J<A;J++){var H=v[J],Q=!0===t?z.materials[H.materialIndex]:x.material;if(void 0!==Q){var aa=Q.side,h=N[H.a],ua=N[H.b],
wa=N[H.c];if(!0===Q.morphTargets){var D=f.morphTargets,U=x.morphTargetInfluences,na=h.position,K=ua.position,ba=wa.position;ia.set(0,0,0);m.set(0,0,0);ea.set(0,0,0);for(var ha=0,la=D.length;ha<la;ha++){var ra=U[ha];if(0!==ra){var sa=D[ha].vertices;ia.x+=(sa[H.a].x-na.x)*ra;ia.y+=(sa[H.a].y-na.y)*ra;ia.z+=(sa[H.a].z-na.z)*ra;m.x+=(sa[H.b].x-K.x)*ra;m.y+=(sa[H.b].y-K.y)*ra;m.z+=(sa[H.b].z-K.z)*ra;ea.x+=(sa[H.c].x-ba.x)*ra;ea.y+=(sa[H.c].y-ba.y)*ra;ea.z+=(sa[H.c].z-ba.z)*ra}}h.position.add(ia);ua.position.add(m);
wa.position.add(ea);n.projectVertex(h);n.projectVertex(ua);n.projectVertex(wa)}if(!1!==n.checkTriangleVisibility(h,ua,wa)){D=n.checkBackfaceCulling(h,ua,wa);if(aa!==THREE.DoubleSide){if(aa===THREE.FrontSide&&!1===D)continue;if(aa===THREE.BackSide&&!0===D)continue}E=k();E.id=x.id;E.v1.copy(h);E.v2.copy(ua);E.v3.copy(wa);E.normalModel.copy(H.normal);!1!==D||aa!==THREE.BackSide&&aa!==THREE.DoubleSide||E.normalModel.negate();E.normalModel.applyMatrix3(ga).normalize();U=H.vertexNormals;na=0;for(K=Math.min(U.length,
3);na<K;na++)ba=E.vertexNormalsModel[na],ba.copy(U[na]),!1!==D||aa!==THREE.BackSide&&aa!==THREE.DoubleSide||ba.negate(),ba.applyMatrix3(ga).normalize();E.vertexNormalsLength=U.length;aa=C[J];if(void 0!==aa)for(D=0;3>D;D++)E.uvs[D].copy(aa[D]);E.color=H.color;E.material=Q;E.z=(h.positionScreen.z+ua.positionScreen.z+wa.positionScreen.z)/3;P.elements.push(E)}}}}}else if(x instanceof THREE.Line)if(f instanceof THREE.BufferGeometry){if(C=f.attributes,void 0!==C.position){t=C.position.array;f=0;for(v=t.length;f<
v;f+=3)n.pushVertex(t[f],t[f+1],t[f+2]);if(void 0!==C.index)for(C=C.index.array,f=0,v=C.length;f<v;f+=2)n.pushLine(C[f],C[f+1]);else for(C=x.mode===THREE.LinePieces?2:1,f=0,v=t.length/3-1;f<v;f+=C)n.pushLine(f,f+1)}}else{if(f instanceof THREE.Geometry&&(oa.multiplyMatrices(ca,O),J=x.geometry.vertices,0!==J.length))for(h=g(),h.positionScreen.copy(J[0]).applyMatrix4(oa),C=x.mode===THREE.LinePieces?2:1,A=1,H=J.length;A<H;A++)h=g(),h.positionScreen.copy(J[A]).applyMatrix4(oa),0<(A+1)%C||(ua=N[G-2],ma.copy(h.positionScreen),
pa.copy(ua.positionScreen),!0===a(ma,pa)&&(ma.multiplyScalar(1/ma.w),pa.multiplyScalar(1/pa.w),S=d(),S.id=x.id,S.v1.positionScreen.copy(ma),S.v2.positionScreen.copy(pa),S.z=Math.max(ma.z,pa.z),S.material=x.material,x.material.vertexColors===THREE.VertexColors&&(S.vertexColors[0].copy(x.geometry.colors[A]),S.vertexColors[1].copy(x.geometry.colors[A-1])),P.elements.push(S)))}else x instanceof THREE.Sprite&&(b.set(O.elements[12],O.elements[13],O.elements[14],1),b.applyMatrix4(ca),f=1/b.w,b.z*=f,-1<=
...
Math.PI/60/60*a.autoRotateSpeed);var b=b+S,e=e+ha,b=Math.max(this.minAzimuthAngle,Math.min(this.maxAzimuthAngle,b)),e=Math.max(this.minPolarAngle,Math.min(this.maxPolarAngle,e)),e=Math.max(1E-6,Math.min(Math.PI-1E-6,e)),d=A.length()*da,d=Math.max(this.minDistance,Math.min(this.maxDistance,d));this.target.add(la);A.x=d*Math.sin(e)*Math.sin(b);A.y=d*Math.cos(e);A.z=d*Math.sin(e)*Math.cos(b);A.applyQuaternion(P);c.copy(this.target).add(A);this.object.lookAt(this.target);ha=S=0;da=1;la.set(0,0,0);if(1E-6<
...
a.update();break;case 2:if(!0===a.noZoom)break;if(l!==u.TOUCH_DOLLY)break;b=c.touches[0].pageX-c.touches[1].pageX;c=c.touches[0].pageY-c.touches[1].pageY;c=Math.sqrt(b*b+c*c);ka.set(0,c);U.subVectors(ka,E);0<U.y?a.dollyOut():a.dollyIn();E.copy(ka);a.update();break;case 3:if(!0===a.noPan)break;if(l!==u.TOUCH_PAN)break;z.set(c.touches[0].pageX,c.touches[0].pageY);G.subVectors(z,I);a.pan(G.x,G.y);I.copy(z);a.update();break;default:l=u.NONE}}},!1);window.addEventListener("keydown",function(c){if(!1!==
...
this.WINDOW_WIDTH/2,g.addEventListener("resize",a,!1));this.renderType=w.webgl?"webgl":"canvas";this.renderer=p||(w.webgl?new d.WebGLRenderer({antialias:!0,preserveDrawingBuffer:!0}):new d.CanvasRenderer({antialias:!0,preserveDrawingBuffer:!0}));this.renderer.setSize(this.WINDOW_WIDTH,this.WINDOW_HEIGHT);this.domParent.appendChild(this.renderer.domElement);this.scene=T||new d.Scene;this.camera=I||new d.PerspectiveCamera(35,this.WINDOW_WIDTH/this.WINDOW_HEIGHT,.1,1E4);this.camera.position.set(1E3,
500,1E3);this.camera.lookAt(this.scene.position);z?this.controls=z:(this.controls=new d.OrbitControls(this.camera,this.renderer.domElement),this.controls.target.set(0,0,0),this.controls.rotateSpeed=1,this.controls.zoomSpeed=1.2,this.controls.panSpeed=.8,this.controls.keys={LEFT:65,FORWARD:87,RIGHT:68,BACKWARD:83,UP:32},this.controls.mouseButtons={ORBIT:d.MOUSE.MIDDLE,PAN:d.MOUSE.RIGHT});e()};g.Base=p;"object"===typeof module&&(module.exports=p)})(window,document,THREE,Detector);
...
a&&(a.position.copy(b.point).add(b.face.normal),a.position.divideScalar(P.width).floor().multiplyScalar(P.width).addScalar(P.width/2))}function z(a){0<a.length&&I(n,a[0])}function G(a,b,e,d){a=a||T(event);if(0<a.length){a=a[0];var g=O.toolsType,f=!1,k=fa.length;if(k&&a.object!==c)for(var l=k-1;0<l&&l>k-1-3;l--)if(a.object===fa[l]){f=!0;break}0===g?!0===f&&!1===b||!1===f&&!0===b||(b=H.draw(0,oa,void 0,a),d?ja.appendObjectToCurrentAction(b):ja.addAction("draw",b)):1===g&&e&&a.object!==c&&(b=H.erase(a.object),
d?ja.appendObjectToCurrentAction(b):ja.addAction("erase",b))}}function N(a){0===b&&(J.save(J.storageKeys.camera),J.save(J.storageKeys.sidebar),J.save())}function A(a){J.save(J.storageKeys.camera);J.save(J.storageKeys.sidebar);J.save();b=1}function E(a){a.preventDefault();var b;1===qa[0]?(b=T(a),G(b,a.ctrlKey,a.ctrlKey,!0)):(b=O.toolsType,1===b?n.visible&&(n.visible=!1):(!n.visible&&ca&&(n.visible=!0),b=T(a),z(b)))}function ka(a){a.preventDefault();switch(a.button){case 0:if(!Z.endFlag){Z.instantComplete(Z.loadBoxAnimation);
break}qa[0]=1;a=T(a);G(a,void 0,!0,!1);0===O.toolsType&&z(a);break;case 1:qa[1]=1;break;case 2:qa[2]=1}}function U(h){if("label"===this.nodeName.toLowerCase())switch(h=this.getElementsByTagName("input")[0],O[h.name]=Number(h.value),h.name){case "toolsType":1===Number(h.value)?n.visible&&(n.visible=!1):!n.visible&&ca&&(n.visible=!0);break;case "textures":oa=O[h.name];ga=t[oa];va=ga.data;ma=ga.helperData=t[O[h.name]].helperData||s(F,va);n.material=ma;k.getElementById("cube").parentElement.click();switch(O.texturesType){case 0:a=
...
this.nodeName.toLowerCase())O[this.id]()}function ha(a){switch(a.button){case 0:qa[0]=0;break;case 1:qa[1]=0;break;case 2:qa[2]=0}}function S(a){}function da(a){if(!qa[0])switch(a.keyCode){case 16:0===O.toolsType?k.getElementById("eraser").parentElement.click():1===O.toolsType&&k.getElementById("cube").parentElement.click();break;case 90:a.ctrlKey&&ja.undo();break;case 89:a.ctrlKey&&ja.redo()}}function la(){requestAnimationFrame(la);m.renderer.render(m.scene,m.camera)}var y=k.createElement("a");y.id=
