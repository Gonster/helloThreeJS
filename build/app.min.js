...
P.changed=c.load(c.storageKeys.localChanges);"0"===b||"0"!==b&&confirm("\u4e0a\u6b21\u5173\u95ed\u524d\u53ef\u80fd\u672a\u5b8c\u6210\u4fdd\u5b58\uff0c\u662f\u5426\u8f7d\u5165\u4e91\u7aef\u6587\u4ef6\uff1f\u82e5\u53d6\u6d88\u5219\u5c06\u672c\u5730\u7248\u672c\u89c6\u4e3a\u65b0\u6587\u4ef6")?(b=new AV.Query(m),b.get(a.id,{success:function(a){g=a;c.loadCamera(g.get("camera"),!0);c.loadMeshes(g.get("meshes"),pa,F.loadBoxAnimation,!0);c.save(c.storageKeys.boxName,g.get("name"));c.save(c.storageKeys.updatedAt,
g.updatedAt);c.save(c.storageKeys.camera);c.save()},error:function(b,e){a.set("meshes",c.load(c.storageKeys.meshes));a.set("camera",c.load(c.storageKeys.camera));c.loadMeshes(void 0,pa,F.loadBoxAnimation)}})):(g=new m,c.save(c.storageKeys.boxId,""),c.save(c.storageKeys.updatedAt,""),c.save(c.storageKeys.boxName,""),c.save(c.storageKeys.localChanges,"1"),this.changed=1,c.loadMeshes(void 0,pa,F.loadBoxAnimation),n("\u7531\u4e8e\u672c\u5730\u6b64\u6587\u4ef6\u4e0e\u4e91\u7aef\u6587\u4ef6\u5728\u540c\u4e00\u6587\u4ef6\u7684\u57fa\u7840\u4e0a\u505a\u4e86\u4e0d\u540c\u7684\u6539\u52a8\uff0c\u5c06\u672c\u5730\u7248\u672c\u4e0e\u4e91\u7aef\u6b64\u6587\u4ef6\u89c6\u4e3a\u4e0d\u540c\u7684\u6587\u4ef6"))}else b=
